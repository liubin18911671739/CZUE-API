...
uses
  ...
  Dialogs, StdCtrls, EtOcxExLib_TLB, OleCtrls, Unit2;

type
    TForm1 = class(TForm)
    OCXObject: TScriptableObject;
    EtOcxEx1: TEtOcxEx;
    btnInit: TButton;
    btnOpen: TButton;
    btnGrab: TButton;
...
begin
//初始化EtOcxEx资源
  EtOcxEx1.CZUR_Initialize(OCXObject, 'delphi.log');
end;
...
begin
  ...
  OCXObject := TScriptableObject.Create;
end;
